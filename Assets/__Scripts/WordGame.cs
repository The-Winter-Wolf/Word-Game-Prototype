...
public class WordGame : MonoBehaviour
{
    ...
    public void WordListParseComplete()
    {
        ...
        // Создать уровень и сохранить currLevel текущий WordLevel
    ...
    public void SubWordSearchComplete()
    {
        ...
        Layout(); // Вызвать метод один раз после выполнения WordSearch
    }
            ...
            case GameMode.inLevel:
                ...
                foreach (char cIt in Input.inputString) {
                    ...
                    if (upperCase.Contains(c)) {
                        ...
                        if (ltr != null) {
                            // добавить этот символ в testWord и переместить соответствующую 
                            // плитку Letter в bigLettersActive
                            testWord += c.ToString();
                    ...
                    if (c == '\n' || c == '\r') { // Return/Enter
                        CheckWord(); // Проверить наличие слова на уровне
                    }
    ...
    // Метод ищет плитку с символом 'c' в bigletters.
    Letter FindNextLetterByChar(char c)
    {
        foreach (Letter ltr in bigLetters) {
            if (ltr.c == c) {return(ltr);}   
        }
        return(null); 
    }

    // Проверить присутствие слова на уровне
    public void CheckWord() 
    {
        string subWord;
        bool foundTestWord = false;
        List<int> containedWords = new List<int>(); // Хранит индексы присутствующих слов
    ...
    // Удаляет все плитки из активных плиток
